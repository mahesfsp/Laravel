                            ...
                            @csrf
                                ...
                                <div class="shadow-sm -space-y-px mb-4">
                                    <div>
								     ...
								     <div class="shadow-sm -space-y-px mb-4">
                                    <div>
                                        <label for="encryption" class="sr-only">Encryption</label>
                                        <input id="encryption" name="encryption" type="text" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Select encryption">
                                    </div>
                                </div>
